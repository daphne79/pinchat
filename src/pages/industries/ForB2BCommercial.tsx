          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <Button size="lg" className="text-base sm:text-lg" asChild>
                <Link to="/register">{t('b2bCommercial.hero.cta')}</Link>
              </Button>
            </div>
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="rounded-lg overflow-hidden">
                <img 
                src={getAssetPath("/lovable-uploads/b2b_feat1.png")} 
                alt="b2b_feat1" 
                className="w-full h-auto" 
                loading="lazy" 
                />
          ...
          <div className="container mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="order-2 lg:order-1 overflow-hidden">
                <img 
                src={getAssetPath("/lovable-uploads/b2b_feat2.png")} 
                alt="b2b_feat2" 
                className="w-full h-auto" 
                loading="lazy" 
                />
        ...
        <section className="bg-primary/10 py-20 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto bg-card border p-12 text-center">
              ...
              <Button size="lg" className="text-base sm:text-lg" asChild>
                <Link to="/register">{t('b2bCommercial.cta.button')}</Link>
              </Button>
            </div>
          </div>
        </section>
