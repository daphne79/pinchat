      ...
      <main>
          ...
          <div className="container mx-auto">
            <div className="text-center mb-12">
              ...
              <Button size="lg" className="text-base sm:text-lg" asChild>
                <Link to="/register">{t('solutions.customerFeedbackAnalyticsPage.hero.cta')}</Link>
              </Button>
            </div>
            ...
            <div className="mt-16 overflow-hidden">
              <img 
                src={getAssetPath("/lovable-uploads/c4bdeedf-e89d-4da0-8aa9-7836171381e3.png")} 
        ...
        <section className="py-24 bg-background px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <Link to="/solutions/ai-customer-service-bot" className="group">
        ...
        <section className="bg-primary/10 py-20 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto bg-card border p-12 text-center">
              ...
              <Button size="lg" className="text-base sm:text-lg" asChild>
                <Link to="/register">{t('solutions.customerFeedbackAnalyticsPage.cta.button')}</Link>
              </Button>
            </div>
          </div>
        </section>
