      ...
      <main className="min-h-screen bg-background">
              ...
              <div className="animate-fade-in text-center mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                  <Button size="lg" className="bg-[#02B13F] hover:bg-[#029f38] text-white text-base sm:text-lg" asChild>
                    <Link to="/register">{t('features.faqPinbotPage.hero.cta')}</Link>
                  </Button>
                </div>
              </div>
        ...
        <section className="py-24 px-4 sm:px-6 md:px-8 lg:px-12 bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-32 animate-fade-in">
            ...
            <div className="order-1 lg:order-2">
              <img 
                src={getAssetPath("/lovable-uploads/faq-chatbot-human-followup.png")} 
                alt="faq-chatbot-human-followup" 
                className="w-full h-auto" 
                loading="lazy" 
                />
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="container mx-auto">
            ...
            <Button size="lg" className="bg-[#02B13F] hover:bg-[#029f38] text-white text-base sm:text-lg min-w-[200px]" asChild>
              <Link to="/register">{t('features.faqPinbotPage.cta.button')}</Link>
            </Button>
          </div>
          </div>
        </section>
